...
function About() {
    const ventajas = [
        { name: 'Tasación Sin Costo', description: 'Te ofrecemos la posibilidad de tasar tu coche sin compromiso.', image: '/images/tasar.png', className: '' },
        ...
        { name: '1 año de Garantía', description: 'Todos nuestros coches vienen con garantía por 12 meses.', image: '/images/garantia.png', className: ''},
